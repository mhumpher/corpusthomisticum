...
def my_form_post():
    ...
    searchTerm = text
    return render_template('CorpThomOutput.html', tables=[df.to_html(classes='data', index = False, escape = False, justify = 'center')], titles=df.columns.values, searchTerm = searchTerm, size = size)
